...
## Current Status
Abilities are already data-driven and split across multiple categories in resource data. Execution is centered on `AbilityExecutor` with support for traits and effects.
