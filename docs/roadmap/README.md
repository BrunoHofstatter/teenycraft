...
## Purpose
This folder is for future planning, rough design notes, experiments, and unresolved idea work.

## Rules
- Do not treat files in this folder as shipped behavior by default.
