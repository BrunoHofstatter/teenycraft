...
outputs = {
    # Let the can and its short motion trail use most of the canvas while
    # retaining transparent corners and enough throwable-profile padding.
    "ability_trash_can_toss.png": fit_subject(
        "trash_can_toss_transparent_source.png",
        target_extent=58,
    ),
    # The previous production icon used a 51x49 alpha footprint. A 54-pixel
    # extent makes the broader revision only modestly larger as requested.
    "ability_batarang_storm.png": fit_subject(
        "batarang_storm_revision_transparent_source.png",
        target_extent=54,
    ),
    # Keep all three four-leaf silhouettes readable in the 32x32 QA view.
    "ability_good_luck.png": fit_subject(
        "good_luck_transparent_source.png",
        target_extent=56,
    ),
}
...
for stem, filename in (
    ("trash_can_toss", "ability_trash_can_toss.png"),
    ("batarang_storm", "ability_batarang_storm.png"),
    ("good_luck", "ability_good_luck.png"),
):
...
qa_sheet(
    [
        ("Trash Can Toss", outputs["ability_trash_can_toss.png"]),
        ("Batarang Storm", outputs["ability_batarang_storm.png"]),
        ("Good Luck", outputs["ability_good_luck.png"]),
    ]
)
