...
images = {
    "heroic_pose": clean_and_resize("heroic_pose_transparent_source_v2.png"),
    "staff_slam": clean_and_resize("staff_slam_transparent_source.png"),
    "trident_throw": clean_and_resize("trident_throw_transparent_source.png"),
}
