...
public class ClientModEvents {
    ...
    public static void onModelBake(ModelEvent.ModifyBakingResult event) {
        AbilityIconManager.refreshAvailableIconModels(Minecraft.getInstance().getResourceManager());
    ...
    private static void registerAbilityProperties(net.minecraft.world.item.Item item) {
        ...
        ItemProperties.register(item, new ResourceLocation(TeenyCraft.MOD_ID, "is_button"), (stack, level, entity, seed) -> {
            ...
            // Model predicates are also evaluated in GUI contexts where entity can
            // be null. ClientBattleData is sufficient to resolve this slot state.
